...
export default function PriceCards() {
  return (
    <section className="relative z-10 max-w-7xl mx-auto px-8 py-24">
      <h2 className="mb-16 text-center text-4xl font-semibold tracking-tight text-slate-300 text-shadow-black/10 text-shadow-lg sm:text-5xl">
        Choose your plan
      </h2>
      ...
      <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
        ...
        >
          <div className="relative z-10">
            ...
            <Link
              href="/auth/signup"
              className="flex w-full items-center justify-center bg-neutral-300 text-black py-4 rounded-lg font-medium hover:bg-gray-200 transition-colors"
            >
              Get started
            </Link>
          </div>
